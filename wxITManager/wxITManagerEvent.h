...
BEGIN_DECLARE_EVENT_TYPES()
    ...
    DECLARE_EVENT_TYPE(wxEVT_DATABASE_GETRESOURCEDEPOLYLIST, 153)
    DECLARE_EVENT_TYPE(wxEVT_DATABASE_ADDRESOURCEDEPOLY, 154)
    DECLARE_EVENT_TYPE(wxEVT_DATABASE_DELETERESOURCEDEPOLY, 155)
    DECLARE_EVENT_TYPE(wxEVT_DATABASE_UPDATERESOURCEDEPOLY, 156)
...
#define EVT_DATABASE_GETRESOURCEDEPOLYLIST(fn) DECLARE_EVENT_TABLE_ENTRY( \
    wxEVT_DATABASE_GETRESOURCEDEPOLYLIST, 0, -1, (wxObjectEventFunction) \
    (wxEventFunction) (wxDatabaseEventFunction) & fn, \
    (wxObject *) NULL ),
#define EVT_DATABASE_ADDRESOURCEDEPOLY(fn) DECLARE_EVENT_TABLE_ENTRY( \
    wxEVT_DATABASE_ADDRESOURCEDEPOLY, 0, -1, (wxObjectEventFunction) \
    (wxEventFunction) (wxDatabaseEventFunction) & fn, \
    (wxObject *) NULL ),
#define EVT_DATABASE_DELETERESOURCEDEPOLY(fn) DECLARE_EVENT_TABLE_ENTRY( \
    wxEVT_DATABASE_DELETERESOURCEDEPOLY, 0, -1, (wxObjectEventFunction) \
    (wxEventFunction) (wxDatabaseEventFunction) & fn, \
    (wxObject *) NULL ),
#define EVT_DATABASE_UPDATERESOURCEDEPOLY(fn) DECLARE_EVENT_TABLE_ENTRY( \
    wxEVT_DATABASE_UPDATERESOURCEDEPOLY, 0, -1, (wxObjectEventFunction) \
    (wxEventFunction) (wxDatabaseEventFunction) & fn, \
    (wxObject *) NULL ),
